...
export default class HighCardLowCardScreen extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <Animated.View
        ...
        <View style={{flex: 2, flexDirection: 'row',justifyContent:'center', alignItems: 'center'}}>
          ...
          <TouchableHighlight onPress={() =>
                        navigate('SuitsGame')
                    } style={{width:150, height: 50 , backgroundColor: 'red', justifyContent:'center', alignItems: 'center', borderRadius:10}}>
